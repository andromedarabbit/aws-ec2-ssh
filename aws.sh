...
# aws - replacement for awscli binary, using docker opsgang/awscli:stable
#
# =================================================
# Put this in your file in your PATH, and chmod a+x
# =================================================
#
# See https://github.com/opsgang/docker_awscli/blob/master/.examples/README.md for more details.
#
_check_var_defined() {
    local var_name="$1"
...
container_as_cmd() {
    ...
    docker run --name $CONTAINER_NAME $DOCKER_OPTS $TAGGED_IMG $cmd_args
}
...
export TAGGED_IMG=opsgang/awscli:stable
container_as_cmd "$@"
